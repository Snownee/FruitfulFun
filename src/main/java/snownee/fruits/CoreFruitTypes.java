...
public class CoreFruitTypes extends AbstractModule {
	...
	public static final KiwiGO<FruitType> TANGERINE = go(() -> new FruitType(0, CoreModule.CITRUS_LOG, CoreModule.TANGERINE_LEAVES, CoreModule.TANGERINE_SAPLING, CoreModule.TANGERINE));
