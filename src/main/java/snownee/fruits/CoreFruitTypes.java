...
public class CoreFruitTypes extends AbstractModule {
	...
	public static final KiwiGO<FruitType> CITRON = go(
			() -> new CoreFruitType(0, CoreModule.CITRUS_LOG, CoreModule.CITRON_LEAVES, CoreModule.CITRON_SAPLING, CoreModule.CITRON));
	public static final KiwiGO<FruitType> POMELO = go(
			() -> new CoreFruitType(1, CoreModule.CITRUS_LOG, CoreModule.POMELO_LEAVES, CoreModule.POMELO_SAPLING, CoreModule.POMELO));
	public static final KiwiGO<FruitType> ORANGE = go(
			() -> new CoreFruitType(1, CoreModule.CITRUS_LOG, CoreModule.ORANGE_LEAVES, CoreModule.ORANGE_SAPLING, CoreModule.ORANGE));
