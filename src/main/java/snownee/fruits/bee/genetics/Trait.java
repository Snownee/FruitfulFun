...
public record Trait(String name, int value, @Nullable Identifier texture) {
	...
	public static final Trait WITHER_TOLERANT = register(new Trait("wither_tolerant", 2, FruitfulFun.id("wither_bee")));
	...
	public static final Trait PINK = register(new Trait("pink", 2, FruitfulFun.id("pink_bee")));
	public static final Trait GHOST = register(new Trait("ghost", 0, FruitfulFun.id("ghost_bee")));
