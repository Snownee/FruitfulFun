...
public class CherryFruitTypes extends AbstractModule {
	...
	public static final KiwiGO<FruitType> CHERRY = go(() -> new FruitType(0, REDLOVE_LOG, CHERRY_LEAVES, CHERRY_SAPLING, CherryModule.CHERRY));
	public static final KiwiGO<FruitType> REDLOVE = go(() -> new FruitType(2, REDLOVE_LOG, REDLOVE_LEAVES, REDLOVE_SAPLING, CherryModule.REDLOVE));
