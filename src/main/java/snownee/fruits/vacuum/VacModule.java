...
public class VacModule extends AbstractModule {
	...
	public static final KiwiGO<SoundEvent> GUN_SHOOT_ITEM = go(() -> SoundEvent.createVariableRangeEvent(new ResourceLocation(
			FruitfulFun.ID,
			"item.gun.shoot_item")));
	public static final KiwiGO<SoundEvent> GUN_WORKING = go(() -> SoundEvent.createVariableRangeEvent(new ResourceLocation(
			FruitfulFun.ID,
			"item.gun.working")));
	public static final KiwiGO<SoundEvent> GUN_STOP = go(() -> SoundEvent.createVariableRangeEvent(new ResourceLocation(
			FruitfulFun.ID,
			"item.gun.stop")));
