...
public class FFRecipeProvider extends FabricRecipeProvider {
	...
	public void buildRecipes(Consumer<FinishedRecipe> exporter) {
		...
		flowerCrown(cherryExporter, CherryModule.CHERRY_CROWN.get(), CherryModule.CHERRY_LEAVES.get());
		flowerCrown(cherryExporter, CherryModule.REDLOVE_CROWN.get(), CherryModule.REDLOVE_LEAVES.get());
