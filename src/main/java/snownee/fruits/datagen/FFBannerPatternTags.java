...
public class FFBannerPatternTags extends FabricTagsProvider<BannerPattern> {
	public FFBannerPatternTags(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
