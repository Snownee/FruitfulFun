...
public class FFLanguageProvider extends KiwiLanguageProvider {
	...
	public void generateTranslations(HolderLookup.Provider lookup, TranslationBuilder builder) {
		builder.add(FFItemTagsProvider.CITRUS_LOGS, "Citrus Logs");
		builder.add(FFItemTagsProvider.REDLOVE_LOGS, "Redlove Logs");
		builder.add(FFItemTagsProvider.TULIPS, "Tulips");
		builder.add(FFItemTagsProvider.GADGET_TOKEN, "Gadget Token");
