...
public class SeasonalBlockTagsProvider extends FabricTagsProvider.BlockTagsProvider {
	...
	public SeasonalBlockTagsProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
